        ...
        <div className="flex items-center justify-between h-16">
          <button onClick={onNavigateHome} className="flex items-center gap-3 group">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-muted-foreground leading-tight">
                {user.role === 'APPLICANT' ? t('applicant.welcome') : user.role === 'REVIEWER' ? t('reviewer.welcome') : t('reviewer.welcome')}
              </p>
            </div>
          </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-right hidden md:block">
              <p className="text-sm font-semibold text-[#1E3A5F]">{user.full_name}</p>
