...
import { HarariStar, HarariGeoPattern } from '@/components/harari/Decorations'
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero */}
        <section className="relative overflow-hidden hero-gradient text-white min-h-[600px] md:min-h-[700px]">
          <HarariGeoPattern className="absolute inset-0 opacity-20" opacity={0.2} />

          {/* Atmospheric blended photo layer — bleeds across the hero */}
          <div
            role="img"
            aria-label="Harar city gate in Harar, Ethiopia"
            className="absolute inset-0 hero-photo-atmospheric"
            style={{ backgroundImage: "url('/harar-jugol-gate.jpg')" }}
          />
          {/* Gradient masks that dissolve the photo into the hero gradient */}
          <div className="absolute inset-0 hero-photo-mask-left" />
          <div className="absolute inset-0 hero-photo-mask-bottom" />
          <div className="absolute inset-0 hero-photo-mask-top" />
          <div className="absolute inset-0 hero-photo-tint" />
